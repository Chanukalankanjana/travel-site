    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-medium">{t("contact.subtitle")}</p>
        </div>
              ...
              {contactMethods.map((method, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-white font-medium text-sm">{method.info}</p>
